...
def update():
    ...
    try:
        parsedData = requests.get("https://raw.githubusercontent.com/Toxic-Noob/MunnuOne/main/more/.version").json()
    except:
    ...
    if (toolVersion != mainVersion):
        ...
        os.system("cd .. && rm -rf MunnuOne && git clone https://github.com/Toxic-Noob/MunnuOne > /dev/null 2>&1")
...
def check(sent):
    ...
    if (sent == amount):
        ...
        psb("\033[92m    [\033[37m*\033[92m] From   : \033[37mMunnuOne\n")
        time.sleep(0.6)
